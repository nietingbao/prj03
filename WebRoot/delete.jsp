...
function oncheck(){
     document.form4.action="Deletepast"; 
...
<div class="yhy">
	   ...
	   <div class="sc" onclick="window.location.href='modify.html';return false">
	   修改日程
	   </div>
...
<div class="lr">
	   ...
	   <div class="cxbtn"  onclick="oncheck()" >确认</div>
	   </form>
        <script language="javascript">
